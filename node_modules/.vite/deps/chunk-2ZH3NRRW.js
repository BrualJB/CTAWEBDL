import {
  ...
  lruMemoize,
  warnOnce
} from "./chunk-TQ6Y2UJU.js";
import {
  NoSsr_default
} from "./chunk-W7LKRFBY.js";
import {
  Popper_default,
  _objectWithoutPropertiesLoose
} from "./chunk-MWXWAOE3.js";
import {
  useThemeProps
} from "./chunk-OVUUPOI3.js";
import {
  Typography_default
} from "./chunk-CVUKDHVI.js";
import {
  HTMLElementType,
  _extends,
  clsx_default,
...
var require_use_sync_external_store_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React57 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = React57.useSyncExternalStore, useRef12 = React57.useRef, useEffect15 = React57.useEffect, useMemo9 = React57.useMemo, useDebugValue = React57.useDebugValue;
...
function useCharts(inPlugins, props, seriesConfig5) {
  ...
  const innerChartRootRef = React10.useRef(null);
...
var useSelectorSeries2 = createSeriesSelectorsOfType("line");
var useSelectorSeriesContext2 = createAllSeriesSelectorOfType("line");
...
var useSelectorSeries4 = createSeriesSelectorsOfType("pie");
var useSelectorSeriesContext4 = createAllSeriesSelectorOfType("pie");
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime4.jsxs)(XAxisRoot, {
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime5.jsxs)(YAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime5.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime5.jsxs)("g", {
        ...
        className: classes.tickContainer,
        children: [!disableTicks && (0, import_jsx_runtime5.jsx)(Tick, _extends({
          x2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && !skipLabel && (0, import_jsx_runtime5.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: tickLabel
        }, axisTickLabelProps))]
      }, index2);
    }), label && isHydrated && (0, import_jsx_runtime5.jsx)("g", {
      className: classes.label,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime6.jsxs)(React24.Fragment, {
    children: [xAxisIds.map((axisId) => {
      ...
      return (0, import_jsx_runtime6.jsx)(ChartsXAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
      ...
      return (0, import_jsx_runtime6.jsx)(ChartsYAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
...
var consumeThemeProps = (name, options, InComponent) => React25.forwardRef(function ConsumeThemeInternal(props, ref) {
  var _a;
  const themedProps = useThemeProps({
    props,
  ...
  const OutComponent = React25.forwardRef(InComponent);
  if (true) {
    OutComponent.displayName = `consumeThemeProps(${name})`;
  }
  return (0, import_jsx_runtime7.jsx)(OutComponent, _extends({}, outProps, {
    classes,
    ref
  }));
});
...
var _excluded6 = ["type", "color", "className", "classes"];
...
var ChartsLabelMark = consumeThemeProps("MuiChartsLabelMark", {
  ...
  return (0, import_jsx_runtime8.jsx)(Root, _extends({
    ...
    children: (0, import_jsx_runtime8.jsx)("div", {
      ...
      children: typeof Component === "function" ? (0, import_jsx_runtime8.jsx)(Component, {
        className: classes == null ? void 0 : classes.fill,
        color: color2
      }) : (0, import_jsx_runtime8.jsx)("svg", {
        viewBox: "0 0 24 24",
        preserveAspectRatio: type === "line" ? "none" : void 0,
        children: type === "circle" ? (0, import_jsx_runtime8.jsx)("circle", {
          className: classes == null ? void 0 : classes.fill,
          r: "12",
          cx: "12",
          cy: "12",
...
true ? ChartsLabelMark.propTypes = {
   ...
   * @default 'square'
   */
  type: import_prop_types6.default.oneOf(["circle", "line", "square"])
} : void 0;
...
function ChartsItemTooltipContent(props) {
  ...
  if ("values" in tooltipData) {
    ...
    return (0, import_jsx_runtime9.jsx)(ChartsTooltipPaper, {
      sx,
      className: classes.paper,
      children: (0, import_jsx_runtime9.jsxs)(ChartsTooltipTable, {
        className: classes.table,
        children: [(0, import_jsx_runtime9.jsxs)(Typography_default, {
          component: "caption",
        ...
        }), (0, import_jsx_runtime9.jsx)("tbody", {
          children: tooltipData.values.map(({
            formattedValue: formattedValue2,
            label: label2
          }) => (0, import_jsx_runtime9.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime9.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              component: "th",
              children: label2
            }), (0, import_jsx_runtime9.jsx)(ChartsTooltipCell, {
  ...
  return (0, import_jsx_runtime9.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime9.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime9.jsx)("tbody", {
        children: (0, import_jsx_runtime9.jsxs)(ChartsTooltipRow, {
          className: classes.row,
          children: [(0, import_jsx_runtime9.jsxs)(ChartsTooltipCell, {
            className: clsx_default(classes.labelCell, classes.cell),
            component: "th",
            children: [(0, import_jsx_runtime9.jsx)("div", {
              className: classes.markContainer,
...
function useColorProcessor(seriesType) {
  const store = useStore();
  const seriesConfig5 = useSelector(store, selectorChartSeriesConfig);
  const colorProcessors = React28.useMemo(() => {
    const rep = {};
...
function usePointerType() {
  ...
  const [pointerType, setPointerType] = React29.useState(null);
  React29.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime10.jsx)(ChartsTooltipPaper, {
    ...
    children: tooltipData.map(({
      ...
      return (0, import_jsx_runtime10.jsxs)(ChartsTooltipTable, {
        className: classes.table,
        children: [axisValue != null && !mainAxis.hideTooltip && (0, import_jsx_runtime10.jsx)(Typography_default, {
          component: "caption",
          ...
          children: seriesItems.map(({
            ...
            return (0, import_jsx_runtime10.jsxs)(ChartsTooltipRow, {
              className: classes.row,
              children: [(0, import_jsx_runtime10.jsxs)(ChartsTooltipCell, {
                className: clsx_default(classes.labelCell, classes.cell),
                component: "th",
...
var _excluded7 = ["trigger", "classes", "children"];
var noAxis = () => false;
...
function ChartsTooltipContainer(inProps) {
  ...
  const anchorEl = React31.useMemo(() => ({
  ...
  const modifiers = React31.useMemo(() => [{
    name: "offset",
    options: {
      offset: () => {
  ...
  return (0, import_jsx_runtime11.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime11.jsx)(ChartsTooltipRoot, _extends({
...
true ? ChartsTooltipContainer.propTypes = {
   ...
   */
  container: import_prop_types9.default.oneOfType([(props, propName) => {
   ...
   */
  popperRef: import_prop_types9.default.oneOfType([import_prop_types9.default.func, import_prop_types9.default.shape({
    current: import_prop_types9.default.shape({
      destroy: import_prop_types9.default.func.isRequired,
      forceUpdate: import_prop_types9.default.func.isRequired,
      setOptions: import_prop_types9.default.func.isRequired,
      state: import_prop_types9.default.shape({
        attributes: import_prop_types9.default.object.isRequired,
        elements: import_prop_types9.default.object.isRequired,
        modifiersData: import_prop_types9.default.object.isRequired,
        options: import_prop_types9.default.object.isRequired,
        orderedModifiers: import_prop_types9.default.arrayOf(import_prop_types9.default.object).isRequired,
        placement: import_prop_types9.default.oneOf(["auto-end", "auto-start", "auto", "bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]).isRequired,
        rects: import_prop_types9.default.object.isRequired,
        reset: import_prop_types9.default.bool.isRequired,
        scrollParents: import_prop_types9.default.object.isRequired,
        strategy: import_prop_types9.default.oneOf(["absolute", "fixed"]).isRequired,
        styles: import_prop_types9.default.object.isRequired
      }).isRequired,
      update: import_prop_types9.default.func.isRequired
    })
  })]),
  /**
   * The props used for each slot inside the Popper.
   ...
   * @default 'axis'
   */
  trigger: import_prop_types9.default.oneOf(["axis", "item", "none"])
} : void 0;
...
function ChartsTooltip(props) {
  ...
  const classes = useUtilityClasses3(propClasses);
  return (0, import_jsx_runtime12.jsx)(ChartsTooltipContainer, _extends({}, props, {
    classes,
    children: trigger === "axis" ? (0, import_jsx_runtime12.jsx)(ChartsAxisTooltipContent, {
      classes
    }) : (0, import_jsx_runtime12.jsx)(ChartsItemTooltipContent, {
      classes
    })
  }));
}
true ? ChartsTooltip.propTypes = {
   ...
   * so it's simply `document.body` most of the time.
   */
  container: import_prop_types10.default.oneOfType([(props, propName) => {
    if (props[propName] == null) {
      return new Error(`Prop '${propName}' is required but wasn't specified`);
    }
    if (typeof props[propName] !== "object" || props[propName].nodeType !== 1) {
   ...
   * A ref that points to the used popper instance.
   */
  popperRef: import_prop_types10.default.oneOfType([import_prop_types10.default.func, import_prop_types10.default.shape({
    current: import_prop_types10.default.shape({
      destroy: import_prop_types10.default.func.isRequired,
      forceUpdate: import_prop_types10.default.func.isRequired,
      setOptions: import_prop_types10.default.func.isRequired,
      state: import_prop_types10.default.shape({
        attributes: import_prop_types10.default.object.isRequired,
        elements: import_prop_types10.default.object.isRequired,
        modifiersData: import_prop_types10.default.object.isRequired,
        options: import_prop_types10.default.object.isRequired,
        orderedModifiers: import_prop_types10.default.arrayOf(import_prop_types10.default.object).isRequired,
        placement: import_prop_types10.default.oneOf(["auto-end", "auto-start", "auto", "bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]).isRequired,
        rects: import_prop_types10.default.object.isRequired,
        reset: import_prop_types10.default.bool.isRequired,
        scrollParents: import_prop_types10.default.object.isRequired,
        strategy: import_prop_types10.default.oneOf(["absolute", "fixed"]).isRequired,
        styles: import_prop_types10.default.object.isRequired
      }).isRequired,
      update: import_prop_types10.default.func.isRequired
    })
  })]),
  /**
   * The props used for each slot inside the Popper.
...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  function ConsumeSlotsInternal(props, ref) {
    ...
    return (0, import_jsx_runtime13.jsx)(Component, _extends({}, outProps, {
      ref
    }));
  }
  return React33.forwardRef(ConsumeSlotsInternal);
};
...
var _excluded9 = ["children", "className", "classes"];
var ChartsLabel = consumeThemeProps("MuiChartsLabel", {
  ...
  return (0, import_jsx_runtime14.jsx)("span", _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    children
...
var _excluded10 = ["direction", "onItemClick", "className", "classes"];
...
var ChartsLegend = consumeSlots("MuiChartsLegend", "legend", {
...
}, React35.forwardRef(function ChartsLegend2(props, ref) {
  ...
  return (0, import_jsx_runtime15.jsx)(RootElement, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    ownerState: props,
    children: data.items.map((item, i) => {
      return (0, import_jsx_runtime15.jsx)("li", {
        children: (0, import_jsx_runtime15.jsxs)(Element, {
          ...
          children: [(0, import_jsx_runtime15.jsx)(ChartsLabelMark, {
            ...
            color: item.color,
            type: item.markType
          }), (0, import_jsx_runtime15.jsx)(ChartsLabel, {
...
var _excluded11 = ["gradientId", "direction", "classes", "className", "rotate", "reverse", "thickness"];
...
var ChartsLabelGradient = consumeThemeProps("MuiChartsLabelGradient", {
  ...
  const isRtl = useRtl();
  return (0, import_jsx_runtime16.jsx)(Root2, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ...
    children: (0, import_jsx_runtime16.jsx)("div", {
      className: classes == null ? void 0 : classes.mask,
      children: (0, import_jsx_runtime16.jsx)("svg", {
        viewBox: "0 0 24 24",
...
true ? ChartsLabelGradient.propTypes = {
   ...
   * @default 'horizontal'
   */
  direction: import_prop_types13.default.oneOf(["vertical", "horizontal"]),
  /**
   * A unique identifier for the gradient.
   * The `gradientId` will be used as `fill="url(#gradientId)"`.
   */
  gradientId: import_prop_types13.default.string.isRequired,
  /**
   ...
   */
  rotate: import_prop_types13.default.bool,
  /**
...
var _excluded12 = ["minLabel", "maxLabel", "direction", "axisDirection", "axisId", "rotateGradient", "reverse", "classes", "className", "gradientId", "labelPosition", "thickness"];
...
var ContinuousColorLegend = consumeThemeProps("MuiContinuousColorLegend", {
  ...
  const minComponent = (0, import_jsx_runtime17.jsx)("li", {
    className: classes == null ? void 0 : classes.minLabel,
    children: (0, import_jsx_runtime17.jsx)(ChartsLabel, {
      className: classes == null ? void 0 : classes.label,
      children: minText
    })
  });
  const maxComponent = (0, import_jsx_runtime17.jsx)("li", {
  ...
  return (0, import_jsx_runtime17.jsxs)(RootElement2, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    ownerState: props,
    children: [reverse2 ? maxComponent : minComponent, (0, import_jsx_runtime17.jsx)("li", {
      className: classes == null ? void 0 : classes.gradient,
      children: (0, import_jsx_runtime17.jsx)(ChartsLabelGradient, {
        direction,
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'horizontal'
   */
  direction: import_prop_types14.default.oneOf(["horizontal", "vertical"]),
  /**
   ...
   * @default 'end'
   */
  labelPosition: import_prop_types14.default.oneOf(["start", "end", "extremes"]),
  /**
   ...
   * Useful for linear gradients that are not in the correct orientation.
   */
  rotateGradient: import_prop_types14.default.bool,
  /**
   * The thickness of the gradient
   * @default 12
   */
...
var _excluded13 = ["direction", "classes", "className", "markType", "labelPosition", "axisDirection", "axisId", "labelFormatter", "onItemClick"];
...
var PiecewiseColorLegend = consumeThemeProps("MuiPiecewiseColorLegend", {
  ...
  return (0, import_jsx_runtime18.jsx)(RootElement3, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    ownerState: props,
    children: orderedColors.map(({
      ...
      return (0, import_jsx_runtime18.jsx)("li", {
        children: (0, import_jsx_runtime18.jsxs)(Element, {
          role: onItemClick ? "button" : void 0,
          type: onItemClick ? "button" : void 0,
          onClick: (
            // @ts-ignore onClick is only attached to a button
          ...
          children: [isTextBefore && (0, import_jsx_runtime18.jsx)(ChartsLabel, {
            className: classes == null ? void 0 : classes.label,
            children: label
          }), (0, import_jsx_runtime18.jsx)(ChartsLabelMark, {
            className: classes == null ? void 0 : classes.mark,
            type: markType,
            color: color2
          }), isTextAfter && (0, import_jsx_runtime18.jsx)(ChartsLabel, {
            className: classes == null ? void 0 : classes.label,
            children: label
          })]
        })
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'extremes'
   */
  labelPosition: import_prop_types15.default.oneOf(["start", "end", "extremes"]),
  /**
   * The type of the mark.
   * @default 'square'
   */
  markType: import_prop_types15.default.oneOf(["square", "circle", "line"]),
  /**
   * Callback fired when a legend item is clicked.
   * @param {React.MouseEvent<HTMLButtonElement, MouseEvent>} event The click event.
...
function ChartsYHighlight(props) {
  ...
  return (0, import_jsx_runtime19.jsxs)(React39.Fragment, {
    children: [isBandScaleY && yScale(axisYValue) !== void 0 && (0, import_jsx_runtime19.jsx)(ChartsAxisHighlightPath, {
    ...
    }), type === "line" && axisYValue !== null && (0, import_jsx_runtime19.jsx)(ChartsAxisHighlightPath, {
...
function ChartsXHighlight(props) {
  ...
  return (0, import_jsx_runtime20.jsxs)(React40.Fragment, {
    children: [isBandScaleX && xScale(axisXValue) !== void 0 && (0, import_jsx_runtime20.jsx)(
    ...
    ), type === "line" && axisXValue !== null && (0, import_jsx_runtime20.jsx)(ChartsAxisHighlightPath, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime21.jsxs)(React41.Fragment, {
    children: [xAxisHighlight && (0, import_jsx_runtime21.jsx)(ChartsXHighlight, {
      type: xAxisHighlight,
      classes
    }), yAxisHighlight && (0, import_jsx_runtime21.jsx)(ChartsYHighlight, {
      type: yAxisHighlight,
      classes
    })]
  });
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime22.jsx)("clipPath", {
    id,
...
true ? ChartsClipPath.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  id: import_prop_types17.default.string.isRequired,
  offset: import_prop_types17.default.shape({
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime23.jsx)(React43.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => {
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime24.jsx)(React44.Fragment, {
    children: yTicks.map(({
      value,
      offset
    }) => {
      var _a;
      return (0, import_jsx_runtime24.jsx)(GridLine, {
        y1: offset,
        y2: offset,
        x1: start,
        x2: end,
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime25.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && (0, import_jsx_runtime25.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      start: drawingArea.top,
      end: drawingArea.height + drawingArea.top,
      classes
    }), horizontal && (0, import_jsx_runtime25.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime26.jsx)(StyledText, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime27.jsx)(StyledText2, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime28.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime28.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
var useChartVoronoi = ({
  ...
  const voronoiRef = React49.useRef({});
  const delauneyRef = React49.useRef(void 0);
  const lastFind = React49.useRef(void 0);
...
var _excluded17 = ["children", "localeText", "plugins", "seriesConfig"];
...
function ChartDataProvider(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(ChartProvider, _extends({}, chartProviderProps, {
    children: (0, import_jsx_runtime29.jsx)(ChartsLocalizationProvider, {
      localeText,
      children
    })
  }));
...
true ? ChartDataProvider.propTypes = {
  ...
  apiRef: import_prop_types19.default.shape({
    current: import_prop_types19.default.any
  }),
  /**
   ...
   */
  series: import_prop_types19.default.arrayOf(import_prop_types19.default.object),
  /**
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime30.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime30.jsxs)(React51.Fragment, {
        children: [(0, import_jsx_runtime30.jsx)("stop", {
          offset,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime30.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime31.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime31.jsx)("stop", {
        offset,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function ChartsContinuousGradientObjectBound(props) {
  ...
  const keyPrefix = `${extremumValues[0]}-${extremumValues[1]}-`;
  return (0, import_jsx_runtime32.jsx)("linearGradient", _extends({
    id: gradientId
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime32.jsx)("stop", {
        offset,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime33.jsxs)("defs", {
    children: [filteredYAxisIds.map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime33.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime33.jsxs)(React54.Fragment, {
          children: [(0, import_jsx_runtime33.jsx)(ChartsContinuousGradient, {
            isReversed: !reverse2,
            scale: scale2,
            colorScale,
            colorMap,
            ...
            gradientId,
            direction: "y"
          }), (0, import_jsx_runtime33.jsx)(ChartsContinuousGradientObjectBound, {
            isReversed: reverse2,
            colorScale,
            colorMap,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime33.jsx)(ChartsContinuousGradientObjectBound, {
          colorScale,
          colorMap,
          gradientId: objectBoundGradientId
...
var ChartsSurface = React55.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  return (0, import_jsx_runtime34.jsxs)(ChartsSurfaceStyles, _extends({
    ownerState: {
      width: propsWidth,
      height: propsHeight
    },
    ...
    ref: handleRef,
    children: [title && (0, import_jsx_runtime34.jsx)("title", {
      children: title
    }), desc && (0, import_jsx_runtime34.jsx)("desc", {
      children: desc
    }), (0, import_jsx_runtime34.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
...
var _excluded19 = ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "onAxisClick", "disableVoronoi", "voronoiMaxRadius", "onItemClick", "disableAxisListener", "highlightedItem", "onHighlightChange", "sx", "title", "xAxis", "yAxis", "zAxis", "rotationAxis", "radiusAxis", "skipAnimation", "seriesConfig", "plugins", "localeText"];
...
function ChartsWrapper(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(Root3, {
    ref: chartRootRef,
    ownerState: props,
    sx,
    children
...
use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2ZH3NRRW.js.map
